 ...
 * Locale:Representa es el lenguaje, la region geografica, variantes del dialecto/idioma, de un
 * usuario 
 * SessionLocaleResolver : guardar el Locale seleccionado por un usario
 * como atributo en el request HTTP 
